...
var cnItems = {
    ...
    "Welcome Back!": "欢迎回来!",
    "Your systems were idle while you were away.": "你不在的时候，你的系统是空闲的。",
    "Build more automated income sources to earn while offline!": "建立更多的自动收入来源，在离线时赚取！",
    "An old industrial scrap bin, warped by time and scorched at the base. But its real value lies in the layers of graff—each tag a name lost to the alleys and backzones of the Junk Grid. Some were burners. Some were just loud. The system remembers them through this shrine to thrown-away brilliance. Tagged by legends. Dumped by all. But it never stops grinding.": "一个旧的工业废料桶，被时间扭曲，底部烧焦了。但它真正的价值在于一层层的涂鸦——每一个标签都是在小巷和垃圾网的后街丢失的名字。有些是燃烧器。有些人只是声音很大。这个系统通过这个被抛弃的辉煌来记住他们。用图例标记。被所有人抛弃。但它从不停止磨人。",
    "Now with 50% more screen real estate... and danger. Enlarges the slot machine window and improves visual feedback. Cost per spin: 1,000,000 Junk. Bigger reels. Bigger risks. Bigger... maybe wins?": "现在屏幕面积增加了50%…和危险。扩大游戏机窗口，改善视觉反馈。每旋转成本：1,000,000垃圾。更大的卷。更大的风险。更大的……也许赢了?",
    "⌛ Chrono Crystal Timer": "⌛时空水晶计时器",
    "📦 Signal Expander": "📦信号扩展器",
    "🔄 Auto Slotter": "🔄自动开槽机",
    "🔧 Crafting Booster Unit": "🔧锻造助推器",
    "🗑️ Graffitied Tribute Bin": "🗑️涂鸦致敬箱",
    "A high-tech device that tracks and displays the countdown for the next Flying Crystal to appear. Uses Junk-Time Synergies to feel when the next Crystal is approaching.": "这是一种高科技设备，可以追踪并显示下一个飞行水晶出现的倒计时。使用垃圾时间协同来感知下一个水晶的到来。",
    "A sleek aerial companion that helps extend the lifespan of floating trash bonuses. One-time purchase.": "一个光滑的空中伴侣，有助于延长漂浮垃圾奖励的寿命。一次性购买。",
    "An efficient processing unit that optimizes your crafting operations. One-time purchase.": "一个有效的处理单元，优化您的工艺操作。一次性购买。",
    "Automatically spins the slot machine every 15 seconds": "自动旋转游戏机每15秒",
    "Automatically spins the slot machine every 15 seconds. Works even when the slot machine window is closed. Let the machine gamble for you while you focus on other tasks": "自动旋转游戏机每15秒。即使在游戏机窗口关闭时也能正常工作。让机器帮你赌一把，你可以专心做其他事情",
    "Basic": "基本",
    "Enlarges the slot machine window and improves visual feedback.": "扩大游戏机窗口，改善视觉反馈。",
    "Floating Trash lasts +5s longer": "漂浮垃圾的持续时间增加5秒",
    "Increases max profiles in Signal Sort from 8 → 10": "信号排序的最大配置文件从8增加到10",
    "More frequencies, more faces. Sometimes two extra choices make all the difference. Permanently increases the maximum profiles shown during the Signal Sort recruitment minigame.": "更多的频率，更多的面。有时候，多出两个选择就能决定一切。永久增加信号排序招募小游戏中显示的最大配置文件。",
    "Reduces Electro Shard spawn cooldown": "减少电子碎片的冷却时间",
    "Sell 10 mil Junk for 1 Scratz. Convert your excess junk into valuable scratz at the standard exchange rate. Perfect for small transactions.": "卖10万垃圾获得 1 刮刮乐把你多余的垃圾按标准汇率兑换成有价值的废品。非常适合小额交易。",
    "Sell 100 mil Junk for 10 Scratz. A more efficient way to exchange larger amounts of junk. Save time by converting in bulk!": "卖100万垃圾得到 10个刮刮乐。一种更有效的方式来交换大量的垃圾。通过批量转换节省时间！",
    "Sell 1000 mil Junk for 100 Scratz. The ultimate exchange option for serious junk collectors. Perfect for large-scale operations.": "卖1000M垃圾换100 刮刮乐。这是严肃的垃圾收集者的终极交换选择。适合大规模操作。",
    "Sell Junk for Scratz": "卖垃圾换刮刮",
    "Tracks and displays the countdown for the next Flying Crystal": "追踪并显示下一个飞行水晶的倒计时",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "Reduces Electro Shard spawn cooldown by 1% (Max 10). A mysterious device that creates an electromagnetic field, attracting Electro Shards more frequently. Stack up to 10 beacons for a maximum 10% reduction in spawn time. Current beacons: ": "减少电子碎片的冷却时间1%（最多10次）。一个能产生电磁场的神秘装置，能更频繁地吸引电子碎片。最多堆叠10个信标，最多减少10%的刷出时间。当前信标：",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPostfix = {
    ...
    " Junk)": " 垃圾)",
    " crafting costs on basic recipes": " 制作成本对于基础配方",
    "": "",
    "": "",
}
