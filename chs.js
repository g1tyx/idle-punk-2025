...
var cnItems = {
    ...
    "Special crafting recipes Post Prestige": "特殊的工艺配方后威望",
    ...
    "Streetrat": "街道",
    "Surge Rider": "骑手飙升",
    "Take advantage of the surge to collect extra junk": "利用浪涌收集额外的垃圾",
    ...
    "The first node is mandatory it unlocks the Tronics Clicker, which is core to late-game systems like ElectroShop, Credit Store, and more.": "第一个节点是强制性的，它可以解锁电子点击器，这是游戏后期系统的核心，如ElectroShop、Credit Store等。",
    ...
    "Their availability increases after your first Prestige, but limited ways to earn them exist earlier in the game.": "在你获得第一个威望后，它们的可用性会增加，但在游戏早期获得它们的方式有限。",
    ...
    "Unlocks the Ascension Protocol Questline": "解锁扬升协议任务线",
    ...
    "Your First Trash Surge": "第一次垃圾激增",
    ...
    "Achievement Unlocked: UI Breaker!": "成就解锁：UI破坏者！",
    "Auto Toolkit": "汽车工具箱",
    "Basic conductive material": "基本导电材料",
    "Basic Materials": "基本材料",
    "Capacitor": "电容器",
    "Click Rig Mk": "点击Rig Mk",
    ...
    "Keep 1 random helper or crafting bonus after Prestige. Energy shield technology that preserves automation through ascension. Can be purchased twice. (": "威望后保留1个随机助手或制造奖励。通过提升保存自动化的能量屏蔽技术。可以购买两次。（",
    ...
    "The circuit's secrets are revealed. Received: 1x Voltage Node": "电路的秘密被揭开了。收到：1x电压节点",
